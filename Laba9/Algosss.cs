...
namespace Lab9
{
    internal class Algosss
    {
        class GOST
        {
            //readonly означает, что значение этого массива можно изменять только в конструкторе объекта класса
        ...
        0xfa,0xf4,0x17,0xd5,0xd9,0xb2,0x1b,0x99,0x48,0xbc,0x92,0x4a,0xf1,0x1b,0xd7,0x20
            ...
            public int outLen = 0; //Эта переменная используется для задания длины выходного хеш-кода
            ...
            // Если результат сложения больше 64 байт, то берется только младший байт каждого слова.
            // Это происходит из-за использования оператора & для обнуления старшего байта каждого слова.
            ...
            //L-преобразование.
            //Представляет собой умножение 64-битного входного вектора на бинарную матрицу A.
        ...
        //Получение случайной строки символов длинной length.
